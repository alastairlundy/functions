...
public static class CalculateFeesOnly
{
 
    [FunctionName("CalculateFeesOnly")]
    public static async Task<IActionResult> RunAsync(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "CalculateFeesOnly")] HttpRequest req, ILogger log)
    {
        decimal price;
